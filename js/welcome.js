// 进行 fetch 请求
fetch('https://api.nsmao.net/api/ip/query?key=EoYrQakkRvJgV6mgcNrTN8mVJz') // 申请地址：https://api.nsmao.net
    .then(response => {
        if (!response.ok) {
...
function showWelcome() {
    ...
    let dist = getDistance(113.598149,34.860331, ipLocation.data.lng, ipLocation.data.lat); // 修改自己的经度（121.413921）纬度（31.089290）
